      ...
      <article className="pt-28 pb-20">
        <div className="mx-auto max-w-3xl px-6">
          ...
          <div className="space-y-6 text-base sm:text-lg text-slate-300 leading-relaxed">
            ...
            <figure className="my-8">
              <img height={"440"} width={"800"} src="/blog-images/cognitive-mismatch.svg" alt="Diagram showing candidates studied levels Remember and Understand while the exam tested Apply, Analyze, and Evaluate" className="w-full rounded-xl border border-slate-700" />
            </figure>
            ...
            <figure className="my-8">
              <img height={"520"} width={"800"} src="/blog-images/study-time-allocation.svg" alt="Comparison chart showing what most candidates allocate versus what the allocation should be across Bloom's levels" className="w-full rounded-xl border border-slate-700" />
            </figure>
