        ...
        <div className="mx-auto max-w-3xl px-6">
          ...
          <div className="space-y-6 text-base sm:text-lg text-slate-300 leading-relaxed">
            ...
            <figure className="my-8">
              <img height={"500"} width={"800"} src="/blog-images/cognitive-heatmap.svg" alt="Example cognitive heatmap showing a PMP candidate with strong Remember/Understand rows and weak Apply/Analyze/Evaluate rows" className="w-full rounded-xl border border-slate-700" />
            </figure>
            ...
            <figure className="my-8">
              <img height={"520"} width={"900"} src="/blog-images/three-patterns.svg" alt="Three diagnostic patterns: the Flashcard Ceiling, the Bootcamp Blindspot, and the Domain Gap — all with same 73 percent overall score" className="w-full rounded-xl border border-slate-700" />
            </figure>
