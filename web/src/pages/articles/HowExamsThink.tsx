        ...
        <div className="mx-auto max-w-3xl px-6">
          ...
          <div className="space-y-6 text-base sm:text-lg text-slate-300 leading-relaxed">
            ...
            <figure className="my-8">
              <img width={800} height={560} src="/blog-images/exam-lenses-grid.svg" alt="Six certifications paired with the reasoning framework each one tests: PMP with PMI Decision Lens, Security+ with CIA Triad Lens, SHRM-CP with Competency Lens, ITIL 4 with Service Value Lens, CSM with Scrum Guide Lens, Six Sigma with DMAIC Lens" className="w-full rounded-xl border border-slate-700" />
            </figure>
            ...
            <ol className="space-y-4 pl-6 list-decimal marker:text-brand-400 my-4">
              ...
              <li>
                <strong className="text-white">Every explanation walks you through the exam's reasoning frame.</strong> For PMP, that's the Exam Lens &mdash; <em>what would PMI want you to do?</em> For Security+, it's the Security Triad &mdash; <em>which leg of the CIA triad is this question protecting?</em> For Network+, it's the OSI Lens &mdash; <em>which layer does this problem actually live at?</em> The framework is built into how the AI explains every answer. You don't just learn the answer; you learn the lens you're supposed to read the question through.
              </li>
              <li>
