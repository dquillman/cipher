        ...
        <div className="mx-auto max-w-3xl px-6">
          ...
          <div className="space-y-6 text-base sm:text-lg text-slate-300 leading-relaxed">
            ...
            <figure className="my-8">
              <img width={800} height={440} src="/blog-images/ceiling-math.svg" alt="Chart showing exam composition: 20% Remember/Understand, 60% Apply/Analyze, 20% Evaluate" className="w-full rounded-xl border border-slate-700" />
            </figure>
            ...
            <figure className="my-8">
              <img width={800} height={460} src="/blog-images/plateau-chart.svg" alt="Line chart showing recall-only prep plateau at 72% versus Bloom's-trained continuing to 93%" className="w-full rounded-xl border border-slate-700" />
            </figure>
            ...
            <figure className="my-8">
              <img width={800} height={380} src="/blog-images/recognition-vs-production.svg" alt="Side-by-side comparison of recognition (plateaus at 70-75 percent) versus production (scales past 90 percent)" className="w-full rounded-xl border border-slate-700" />
            </figure>
            ...
            <p>
              Every question in every CIPHER bank is classified by Bloom's level. Your accuracy per level is tracked separately from your accuracy per topic. The study plan targets your weakest level first, using the method that trains that level.
            </p>
