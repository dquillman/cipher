...
<p style="margin-top:24px"><a href="https://cipherexam.com" style="color:#4f46e5">Back to CipherExam</a></p>
  ...
  try {
    await recordOptOut(email, "one-click-unsubscribe");
  } catch (err) {
  ...
  page(
    "You're unsubscribed",
    "You will not receive any more marketing email from CipherExam. If you have an account, this does not affect service messages about it.",
    200,
  );
});
